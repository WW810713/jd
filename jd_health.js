...
const inviteCodes = [`P04z54XCjVUnoaW5m9cZ2b43yoex0W24uDAsaQ`,`P04z54XCjVUnoaW5nJcXCCyoR8C6i9QR16e`, `P04z54XCjVUnoaW5m9cZ2b43yoex0W24uDAsaQ`, 'P04z54XCjVUnoaW5nJcXCCyoR8C6i9QR16e'];
!(async () => {
  await requireConfig();
  if (!cookiesArr[0]) {
